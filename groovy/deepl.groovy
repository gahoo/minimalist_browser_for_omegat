...
def hide_elements = """
// document.getElementsByClassName('lmt__sides_container')[0].style.display='block'
// document.getElementsByClassName('lmt__sides_container')[0].style.flexDirection='column-reverse'
// document.getElementsByClassName('lmt__side_container--source')[0].style.display = 'none'
// document.getElementsByClassName('lmt__side_container--source')[0].style.display = 'block'
document.getElementsByClassName('lmt__side_container--source')[0].style.flexBasis='30%'
document.getElementsByClassName('lmt__textarea_container')[0].style.minHeight='0px'
document.getElementsByClassName('lmt__textarea_separator')[0].style.display='none'
...
document.getElementsByClassName('dl_body--redesign')[1].style.display='none'
document.getElementsByClassName('dl_footerV2_container')[0].style.display='none'
...
//document.getElementsByClassName('lmt__side_container--target')[0].style.display='block'
document.getElementsByClassName('lmt__side_container--target')[0].style.flexBasis='70%'
document.getElementById('dl_translator').style.padding=0
"""
...
"""
            ...
            pane.getBrowser().getWebEngine().executeScript(hide_elements)
        }
    })
}
