...
def FILENAME = "ensenble.groovy"
def KEY = "ensenble"
def TITLE = "Linguee|Merriam Webster"
def DOMAIN = /^.*/
def URL = "http://192.168.1.100:5678/linguee,merriam-webster"
...
Core.getEditor().registerPopupMenuConstructors(1000, new IPopupMenuConstructor() {
    ...
    void addItems(JPopupMenu menu, JTextComponent comp, int mousepos, boolean isInActiveEntry,
        ...
        if (isInActiveEntry) {
            menu.addSeparator()
            JMenuItem menuItem = menu.add("Search in Ensenmble")
...
def actionMapKey = "searchInEnsemble"
