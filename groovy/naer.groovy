...
def FILENAME = "naer.groovy"
def KEY = "naer"
def TITLE = "naer"
def DOMAIN = /^.*/
def URL = "http://192.168.1.100:5678/naer_search"
...
KeyStroke keystroke = KeyStroke.getKeyStroke(KeyEvent.VK_OPEN_BRACKET, COMMAND_MASK)
def actionMapKey = "searchInNAER"
